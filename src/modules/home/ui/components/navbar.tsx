 ...
 <div className="pb-3">
      <p className="flex justify-center text-sm">
        <a href="/pricing" className="group">
          ...
          <span className={cn("me-1 text-sm leading-none", !isScrolled && isHomepage ? "text-white" : "")}>   <span className="me-1 text-base leading-none ">✨</span>       Sign up before prices increase on August 1          </span>
